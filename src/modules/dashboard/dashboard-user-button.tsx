      ...
      <Drawer>
        <DrawerTrigger className="rounded-lg border border-border/10 p-3 w-full flex items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden">
          ...
          <div className="flex flex-col gap-0.5 text-left overflow-hidden flex-1 min-w-0 ml-2">
            <p className="text-sm font-semibold tracking-wide truncate w-full text-white">
              {data.user.name}
            </p>
        ...
        <DrawerContent>
          ...
          <DrawerFooter className="flex flex-col gap-2">
            <button
              ...
              className="w-full flex items-center justify-between rounded-lg border border-border/10 p-3 bg-white/5 hover:bg-white/10"
            >
              Billing
